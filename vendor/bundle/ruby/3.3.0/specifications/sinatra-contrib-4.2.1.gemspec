# -*- encoding: utf-8 -*-
# stub: sinatra-contrib 4.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<multi_json>.freeze, [">= 0.0.2".freeze])
  s.add_runtime_dependency(%q<mustermann>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<rack-protection>.freeze, ["= 4.2.1".freeze])
  s.add_runtime_dependency(%q<sinatra>.freeze, ["= 4.2.1".freeze])
